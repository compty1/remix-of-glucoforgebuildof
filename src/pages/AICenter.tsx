      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center mb-12 mt-6">
          ...
          <p className="text-xs text-muted-foreground mt-3 max-w-xl mx-auto">
            Predictions and scenario content are research-based projections updated manually from published literature and clinical trial data — not real-time AI generation.
          </p>
        </section>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="font-semibold text-lg">Research-Based Projections</h3>
                          <Badge variant="outline" className="text-xs bg-warning/10 text-warning border-warning/20">Updated Manually</Badge>
                        </div>
                        <p className="text-muted-foreground text-sm">
                          These projections are compiled from current clinical trial pipelines, 
                          technology development trajectories, and regulatory approval patterns. 
                          Probability estimates reflect expert analysis of funding levels, 
                          research momentum, and technical feasibility — they are not dynamically generated by AI.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                        ...
                        <CardHeader>
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <CardDescription>Pre-written educational content</CardDescription>
                            </div>
                          </div>
                        </CardHeader>
                        <CardContent>
                      ...
                      <CardHeader>
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <CardDescription>Evidence-Based Educational Content</CardDescription>
                          </div>
                        </div>
                      </CardHeader>
