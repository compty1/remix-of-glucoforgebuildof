  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-lg flex items-center gap-2" id="heatmap-title">
      ...
      <CardContent>
        {/* Issue 154: role="img" and aria-label for screen readers */}
        <div role="img" aria-labelledby="heatmap-title" aria-label="Glucose heatmap showing average values by hour of day">
          <TooltipProvider>
                        ...
                        <Tooltip key={hourData.hour}>
                          <TooltipTrigger asChild>
                            <div
                              ...
                              aria-label={`${formatHour(hourData.hour)}: ${hourData.avg > 0 ? Math.round(hourData.avg) + ' mg/dL' : 'no data'}`}
                            >
                              <span className="text-white drop-shadow-sm" aria-hidden="true">
          ...
          <div className="mt-6 pt-4 border-t border-border">
            ...
            <div className="flex flex-wrap gap-2 text-xs" aria-label="Color legend">
              <div className="flex items-center gap-1">
                <div className="w-4 h-4 rounded bg-red-600" aria-hidden="true"></div>
                <span>&lt;54 Very Low</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-4 h-4 rounded bg-amber-500" aria-hidden="true"></div>
                <span>54-70 Low</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-4 h-4 rounded bg-emerald-500" aria-hidden="true"></div>
                <span>70-140 Optimal</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-4 h-4 rounded bg-emerald-400" aria-hidden="true"></div>
